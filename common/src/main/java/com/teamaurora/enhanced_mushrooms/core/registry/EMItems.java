...
public class EMItems {
    ...
    public static final Supplier<Item> GLOWSHROOM_BOAT_ITEM = ITEMS.register("bop_glowshroom_boat", () -> new PollinatedBoatItem(EMEntities.GLOWSHROOM_BOAT, new Item.Properties().stacksTo(1).tab(CreativeModeTab.TAB_TRANSPORTATION)));
